...
class HomeScreenState extends State<HomeScreen> {
  ...
  Widget _buildAssigneeBadge(Map<String, dynamic> tarefa) {
    final nome = (tarefa['assignee_nome'] as String?)?.trim();
    final username = (tarefa['assignee'] as String?)?.trim();
    final displayName = (nome?.isNotEmpty == true)
        ? nome!
        : (username?.isNotEmpty == true ? username! : 'Sem atribuição');
    final initials = displayName == 'Sem atribuição'
        ? '?'
        : displayName
              .split(RegExp(r'\s+'))
