...
class _MainScreenState extends State<MainScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: IndexedStack(
        index: _currentIndex,
        children: [
          HomeScreen(key: _homeKey, onTasksChanged: () => setState(() {})),
          ClientesScreen(key: _clientesKey),
      ...
      child: SizedBox(
        ...
        child: Row(
          ...
          children: [
            ...
            _navItem(Icons.verified_user, 2),
  ...
  void _abrirModalCadastro() {
    ...
    final usuariosFuture = _apiService.getUsuarios();
    Map<String, dynamic>? selectedCliente;
    Map<String, dynamic>? selectedAssignee;
                    ...
                    onPressed: isSaving
                        ...
                        : () async {
                            ...
                            if (sucesso) {
                              ...
                              _clientesKey.currentState?.refreshData();
                              setState(() {});
                            } else {
